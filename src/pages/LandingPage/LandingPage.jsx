...
function LandingPage() {
  ...
  function thirdClicked(e) {
    ...
    if (optionFour === true) {
      window.scrollTo({
        top: document.body.scrollHeight + 399.5,
        behavior: "smooth",
      });
    }
  }
        ...
        <div className="main">
          <div className="main__progression">
            <div className="main__progression-box">
              {progressOne === true && (
                <img
                  className="main__progression-img"
                  src={progressImgOne}
                  alt="progression of search query indicator"
                />
              )}
              {progressTwo === true && (
                <img
          ...
          <div className="main__content">
            ...
            {optionOne === true && (
              <div className="main__content-box content-two">
                <div className="main__option">
                  <h2 className="main__option-title">
                    2. What kind of people data are you looking for?
                  </h2>
                  <div className="main__option-buttons">
                    <button className="main__option-button" onClick={clicked}>
                      Talent Management
                    </button>
                    <button
                      className="main__option-button"
            ...
            {optionOne === true && optionTwo === true && (
              <div className="main__content-box content-three">
                <div className="main__option">
                  <h2 className="main__option-title">
                    3. What kind of Employee data are you looking for?{" "}
